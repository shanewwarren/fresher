...
pub async fn run(max_iterations: Option<u32>) -> Result<()> {
    ...
    println!("{}", "Starting Fresher (Planning Mode)".bold().blue());
    println!("{}", "─".repeat(40));
    println!();
